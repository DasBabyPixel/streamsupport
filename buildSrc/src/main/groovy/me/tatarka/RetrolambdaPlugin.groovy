...
public class RetrolambdaPlugin implements Plugin<Project> {
    protected static String retrolambdaCompile = "net.orfjackal.retrolambda:retrolambda:2.5.7"
    ...
    void apply(Project project) {
        ...
        retrolambdaConfig.canBeResolved = true
        retrolambdaConfig.canBeConsumed = false
